...
exports.run = async (client, message, args, color) => {
  ...
  if (!args[0]) {
    ...
    .setFooter(`Untuk mengetahui cara menggunakan command, ketik ${prefix}help <commands> // Total: ${client.commands.size}`)
...
exports.help = {
    name: 'help',
    description: 'Menampilkan daftar perintah dari KuuHaku',
    usage: 'help'
}
