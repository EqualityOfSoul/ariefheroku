exports.run = async (client, message, args) => {
    ...
    if (!member) return message.channel.send(`**${message.author.username}**, Maaf aku tidak bisa mencari member yang kamu maksud!`);
    ...
    if (member.roles.has(muterole.id)) return message.channel.send(`**${message.author.username}**, dia sudah ter-mute.`);
